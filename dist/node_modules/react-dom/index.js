(function (global, factory) {
    ...
    const createWorkInProgress = (current, penddingProps) => {
    ...
    const HostRoot = 3;
    const HostComponent = 5; // <div>123</div>
    const HostText = 6;
    ...
    function childReconciler(shouldTrackEffexts) {
    ...
    const createTextInstance = (context) => {
        return document.createTextNode(context);
    };
    const appendChildToContainer = appendInitialChild;

    let nextEffect = null;
    const commitMutationEffects = (finisheWork) => {
    ...
    function updatedContainer(reactElement, root) {
